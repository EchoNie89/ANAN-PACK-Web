...
test("package test script includes the contact regression in the standard test path", () => {
  ...
  assert.match(
    packageSource,
    /"test":\s*"node --test --test-concurrency=1 tests\/contact-form-integration\.test\.mjs tests\/home-hero\.test\.mjs tests\/home-value-props-icons\.test\.mjs tests\/page-hero-viewport\.test\.mjs tests\/image-optimization\.test\.mjs tests\/site-settings\.test\.mjs tests\/testimonials-figma\.test\.mjs"/,
