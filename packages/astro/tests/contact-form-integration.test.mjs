...
test("package test script includes the contact regression in the standard test path", () => {
  ...
  assert.match(
    packageSource,
    /"test":\s*"node --test tests\/contact-form-integration\.test\.mjs tests\/home-hero\.test\.mjs tests\/image-optimization\.test\.mjs tests\/site-settings\.test\.mjs tests\/testimonials-figma\.test\.mjs"/,
