...
const image = (
  ...
  sanityKey: string,
  options: Partial<
    Pick<ProductImage, 'width' | 'height'>
  > = {},
): ProductImage => ({
  imagePath: src,
  alt,
...
export const productSourcePages: ProductPageData[] = [
  {
    slug: 'hanging-tag',
...
export const getProductBySlug = (slug: string) =>
  productSourcePages.find((product) => product.slug === slug);
