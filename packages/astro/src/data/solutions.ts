      ...
      sections: [
        {
          title: "The Challenge:",
          body:
            "The brand needed packaging that felt premium, avoided disposable plastic, and remained practical for shipping, display, and repeat customer use.",
        },
        {
          title: "Our Solution:",
          bullets: [
      ...
      items: [
        {
          ...
          description: "New collections often need small runs before demand is proven.",
        },
        {
          icon: "sample",
          title: "High Sampling Cost",
          description: "Multiple suppliers can make every trim sample expensive and slow.",
        },
        {
          icon: "refresh",
          title: "Brand Consistency",
          description: "Tags, labels, seals, bags, and boxes need one coordinated color language.",
        },
        {
          icon: "chat",
          title: "Slow Responses & Missed Deadlines",
          description: "Production delays happen when approvals are split across too many vendors.",
        },
      ],
    },
    strips: [
      ...
      sections: [
        {
          title: "The Challenge:",
          body:
            "The brand needed a cohesive label suite across product sizes without paying luxury-packaging MOQs for every small batch.",
        },
        {
          title: "Our Solution:",
          bullets: [
      ...
      items: [
        {
          icon: "stack",
          title: "Fading & Wash",
          description: "Labels must survive repeated washing without losing legibility or softness.",
        },
        {
          icon: "box",
          title: "Packaging Bulk",
          description: "Bulky textiles need protective packaging that still ships efficiently.",
        },
        {
          icon: "refresh",
          title: "SKU Sensitivity",
          description: "Sizes, sets, colorways, and care details must be packed with low error rates.",
        },
        {
          icon: "shield",
          title: "Global Compliance",
          description: "Care labels and packaging claims need to align with destination-market rules.",
        },
      ],
    },
    strips: [
      ...
      sections: [
        {
          title: "The Challenge:",
          body:
            "Glossy plastic tape felt cheap against high-end home goods, while standard eco tapes failed to adhere reliably to recycled cartons.",
        },
        {
          title: "Our Solution:",
          bullets: [
      ...
      sections: [
        {
          title: "The Challenge:",
          body:
            "The brand needed protective jewelry packaging with a delicate color palette, clean finishing, and enough structure for shipping.",
        },
        {
          title: "Our Solution:",
          bullets: [
